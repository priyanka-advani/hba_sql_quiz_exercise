...
SELECT a.id, a.status, a.order_total FROM orders a ,customers b WHERE a.customer_id = b.id and b.email='pclark74@gmail.com';
...
SELECT a.common_name, a.melon_type, b.quantity, b.unit_price, b.total_price FROM melons a , order_items b WHERE b.order_id = 2725 and b.melon_id=a.id;
...
SELECT b.first_name, b.last_name, sum(a.order_total) AS sales_total, sum(a.order_total)*0.15 AS commission FROM salespeople b LEFT JOIN orders a ON  a.salesperson_id = b.id GROUP BY  b.id
;